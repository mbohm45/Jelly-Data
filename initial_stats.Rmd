...
polyp_clean$ordertreatment = ordered(polyp_clean$treatment, levels = c("Control", "Caffeine", "Estradiol", "Combo"))
polyp_clean$orderT = relevel(polyp_clean$treatment, "Control")
mod_buds <- gamlss(prop_buds ~ ordertreatment*collection_day 
                   + random(jar_code), 
                   family = GB2(), 
                   data = polyp_clean, 
                   method = CG(), 
