...
polyp_clean <- polyp_data %>%
  ...
  mutate(prop_elongated = num_elongated/total_num + 0.001, 
         ...
         collection_day = as.factor(collection_day),
...
b_NB1 <- histDist(polyp_clean$num_ruffled, "NBI", density = T)
...
GAIC(b_lNO, b_GA, b_WEI, b_NB2, b_NB1)
...
# p-value is significant for collection day (6.74e-05)
...
# p-value significant for collection day (2.84e-11), caffeine (0.0278) and combo (0.0298)
...
# p-value significant for collection day (4.48e-07), combo (0.00201) and combo through time (0.03919)
...
summary(mod_total)
# p-value significant for collection day (0.0111)

```


# Summary of Count Data With Total:
Elongation = collection day (6.74e-05)
Ruffled = collection day (2.84e-11), caffeine (0.0278) and combo (0.0298)
Buds = collection day (4.48e-07), combo (0.00201) and combo through time (0.03919)
Total = collection day (0.0111)
